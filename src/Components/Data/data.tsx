...
export const slideData = [
    {
        ...
        highlight: "The Seven.",
        description: "Elementor 2025 full-feature demo: lots of unique page layouts, templates, and online store options.",
        image: "/bg-1.jpg",
        cta: "Buy The7 · $39"
    },
    {
        ...
        highlight: "Next Gen.",
        description: "Empowering businesses with high-performance full-stack applications and modern UI/UX designs.",
        image: "/bg-2.jpg",
        cta: "View Services"
    },
    {
        ...
        highlight: "Creative.",
        description: "We build scalable digital products using React, Next.js, and cutting-edge cloud technologies.",
        image: "/bg-3.jpg",
        cta: "Start Project"
    }
];
...
export const testimonials = [
    {
        ...
        role: "Seven Studio - Artist",
        title: "Top quality & service",
        content: "Nullam tincidunt – dignissim augue, eu condimentum rutrum lorem ipsum eu condimentum libero orci dapibus dignissim velit vitae fermentum.",
        image: "https://i.pravatar.cc/150?u=christina"
    },
    {
        name: "Gregory Brown",
