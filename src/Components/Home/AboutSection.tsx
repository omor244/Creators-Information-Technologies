...
const AboutSection = () => {
    ...
    return (
        <section className="relative w-full h-auto lg:h-[700px] bg-[#0a0a0a] py-16 lg:py-0 px-6 md:px-12 lg:px-20 font-sans selection:bg-cyan-500/30 overflow-hidden flex items-center">
            ...
            <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">

                {/* Left Side: Image Container */}
                <div className="relative w-full aspect-square lg:h-[500px] lg:w-[500px] rounded-3xl border border-white/10 shadow-2xl overflow-hidden group justify-self-center lg:justify-self-start">
                    <img
                        src={imageUrl}
                    ...
                    <div className="grid grid-cols-2 gap-6 w-full pt-2">
                        ...
                        <div className="space-y-1">
                            <div className="flex items-baseline gap-1">
                                <span className="text-lg font-medium text-cyan-500">est.</span>
                                <span className="text-4xl md:text-5xl font-extrabold text-white tracking-tighter">2012</span>
                            </div>
                        ...
                        <div className="space-y-1">
                            <div className="flex items-baseline gap-1">
                                <span className="text-4xl md:text-5xl font-extrabold text-white tracking-tighter">94,5</span>
